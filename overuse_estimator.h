...
// TODO(terelius): This is only used in overuse_estimator.cc, and only in
// the default constructed state. Can we move the relevant variables into
// that class and delete this?
